...
The course will start with introducing topics from traditional Data Assimilation (DA) and Bayesian inference and will make it through to the latest developments in Differential Programming (DP), Simulation-Based Inference (SBI), ML-enabled DA the use of Generative AI.
...
- Neural Density Estimation
  ...
  - score-based diffusion and flow matching
