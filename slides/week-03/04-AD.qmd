...
Differential programming is a technique for [automatically computing the derivatives]{style="color: magenta"} of functions (code).
...
-   Solving [differential equations]{style="color: magenta"}---this can be used to model the behavior of physical systems. (**Caution: this does not scale!!!**)
...
## Automatic Differentiation—backprop, autograd, [Zygote.jl](https://fluxml.ai/Zygote.jl/stable/), etc.{.smaller}
...
-   These frameworks have served as a core technology for the ML
    ...
    -   Julia's ML with [Flux.jl](http://fluxml.ai/Flux.jl/stable/) and AD with [Zygote.jl](https://fluxml.ai/Zygote.jl/stable/) and abstractions with [ChainRules.jl](https://github.com/JuliaDiff/ChainRules.jl) and [AbstractDifferentiation.jl](https://github.com/JuliaDiff/AbstractDifferentiation.jl)
...
Recall: the adjoint-state method is the theoretical basis for [Data
    ...
    problems --- Lecture on Adjoint Methods.
:::
...
-   can easily be written as a [computational graph]{style="color: magenta"} with
