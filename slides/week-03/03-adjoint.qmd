...
6.  In many real problems, the optimization of the misfit functional
    ...
    e. [Model-space extensions]{style="color: magenta"} that extend the search space, e.g. by replacing PDE constraints by penalties (solution of PDE becomes a variable) or by introducing operator coefficients.
...
- fast and scalable codes (e.g. [Full-waveform inversion](https://slim.gatech.edu/research/full-waveform-inversion), see also [JUDI.jl](https://github.com/slimgroup/JUDI.jl))
