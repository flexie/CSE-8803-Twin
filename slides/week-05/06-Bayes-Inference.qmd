...
**Definition 11.2 (QoI).** *In an uncertainty quantification problem, we seek statistical information about a chosen output of interest. This statistic is known as the quantity of interest (QoI) and is usually defined by a high-dimensional integral. The QoI accounts for uncertainty in the model or process.*
...
We have $$\mathcal{D}=\left\{(\mathbf{x}_i,y_i),\,i=1,\dots n\right\}$$
