...
This composition of linear maps is also a linear map.
...
we could also obtain the Jacobian by left-multiplying row basis vectors $e_1^\top$ to $e_m^\top$. 
