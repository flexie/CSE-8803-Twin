...
| [A toolbox for digital twins: from model-based to data-driven](https://epubs.siam.org/doi/book/10.1137/1.9781611976977)[^1] | @asch2022toolbox, Mark | SIAM, 2022 |

[^1]: [This 1000 page book is rather comprehensive. While the complete material is beyond this course, you are encouraged to use the extensive cross-referencing in this book to your advantage. **This book is available in electronic form (pdf) when online on Georgia Tech Campus.**](https://epubs.siam.org/doi/book/10.1137/1.9781611976977)
...
| [Some models are useful, but how do we know which ones? Towards a unified Bayesian model taxonomy](https://projecteuclid.org/journals/statistics-surveys/volume-17/issue-none/Some-models-are-useful-but-how-do-we-know-which/10.1214/23-SS145.short) | @burkner2023some | Statist. survey, 2023 |
| [Diffusion Models in Simulation-Based Inference: A Tutorial Review](https://arxiv.org/abs/2512.20685) | @arruda2025diffusion | Arxiv, 2025 |
